...
from videosearch.helpers import (get_last_video_date_from_page_token,
                                 convert_last_video_date_to_page_token)
...
class YoutubeVideosAPIView(generics.RetrieveAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            page_last_video_epoch = get_last_video_date_from_page_token(page_token)
        ...
        next_page_token = convert_last_video_date_to_page_token(int(new_last_video_epoch))
        data = {
